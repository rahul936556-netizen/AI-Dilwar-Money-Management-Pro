...
th,td{padding:6px;border-bottom:1px solid rgba(255,255,255,.2);text-align:center}
</style>
</head>
...
<h3>Trade History</h3>
<table>
<thead><tr><th>#</th><th>Result</th><th>Amount</th><th>Capital</th></tr></thead>
...
function submitTrade(){
  ...
  historyData.push({n:trades,r:tradeResult.value,a:amt,c:current});
  updateTrade();
  render();
  if(trades>=MAX){
    lockSystem();
